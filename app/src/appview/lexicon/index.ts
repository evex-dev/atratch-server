...
export class LandNS {
  ...
  constructor(server: Server) {
    this._server = server
    this.evex = new LandEvexNS(server)
  }
}

export class LandEvexNS {
  _server: Server
  atratch: LandEvexAtratchNS

  constructor(server: Server) {
    this._server = server
    this.atratch = new LandEvexAtratchNS(server)
  }
}

export class LandEvexAtratchNS {
  _server: Server
